...
# functions for ReSEM
#setwd("/Users/Victor/Desktop/Simu4")
source("ReSEM.R")
# for reproducibility
set.seed(424)
...
# sample proportion, treated proportion and control proportion
f = n/N
r1 = 0.5
r0 = 1 - r1
